...
#define STRING_SPLASH_LINE2 "Sunhokey Prusa i4" // WEBSITE_URL         // will be shown during bootup in line 2
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_BASE_15 //указал материнскую плату вместно 33 (BOARD_RAMPS_13_EFB)
#endif
 ...
 */
#define POWER_SUPPLY 1 //Внимание!!!

#if POWER_SUPPLY > 0
  // Enable this option to leave the PSU off at startup.
  // Power to steppers and heaters will need to be turned on with M80.
  //#define PS_DEFAULT_OFF    //Внимание!!! Возможно это нужно раскомментировать и установить значение ON, т.е. #define PS_DEFAULT_ON
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.2, 80.2, 400.15, 96.8 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 110), (Y_MAX_POS - 5), 5 }
...
//#define LCD_LANGUAGE ru //(руссификатор не сработал)Внимание!!!
 ...
 */
#define DISPLAY_CHARSET_HD44780 JAPANESE  //Внимание!!! Руссификатор не сработал
